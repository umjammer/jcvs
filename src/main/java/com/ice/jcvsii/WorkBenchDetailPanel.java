...
public class WorkBenchDetailPanel extends JPanel implements ActionListener, PropertyChangeListener {
    ...
    public void savePreferences() {
        ...
        prefs.removePropertyChangeListener(Config.WB_DET_TITLE_BG, this);
        prefs.removePropertyChangeListener(Config.WB_DET_TITLE_FONT, this);
        prefs.removePropertyChangeListener(Config.WB_DET_TITLE_HEIGHT, this);
    }
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        switch (propName) {
        case Config.WB_DET_TITLE_BG:
            title.setBackground(p.getColor(Config.WB_DET_TITLE_BG, title.getBackground()));
            break;
        case Config.WB_DET_TITLE_HEIGHT:
            title.setPreferredSize(new Dimension(125, p.getInteger(Config.WB_DET_TITLE_HEIGHT, title.getSize().height)));
            title.revalidate();
            break;
        case Config.WB_DET_TITLE_FONT:
            title.setFont(p.getFont(Config.WB_DET_TITLE_FONT, title.getFont()));
            title.revalidate();
            break;
        }
    ...
    private void establishContents() {
        ...
        this.title.setPreferredSize(new Dimension(125, prefs.getInteger(Config.WB_DET_TITLE_HEIGHT, 35)));
        this.title.setBackground(prefs.getColor(Config.WB_DET_TITLE_BG, new Color(232, 232, 255)));
        this.title.setFont(prefs.getFont(Config.WB_DET_TITLE_FONT, new Font("SansSerif", Font.BOLD, 14)));
        ...
        prefs.addPropertyChangeListener(Config.WB_DET_TITLE_BG, this);

        prefs.addPropertyChangeListener(Config.WB_DET_TITLE_FONT, this);

        prefs.addPropertyChangeListener(Config.WB_DET_TITLE_HEIGHT, this);
        ...
        AWTUtilities.constrain(infoPan, lbl, GridBagConstraints.NONE, GridBagConstraints.WEST, 0, row, 1, 1, 0.0, 0.0);

        this.projectToke = new DetailLabel("  ");
        AWTUtilities.constrain(infoPan, this.projectToke, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST, 1, row++, 1, 1, 1.0, 0.0, new Insets(1, 3, 3, 1));
        ...
        AWTUtilities.constrain(infoPan, this.repository, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST, 1, row++, 1, 1, 1.0, 0.0, new Insets(1, 3, 3, 1));
        ...
        AWTUtilities.constrain(infoPan, this.rootDirectory, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST, 1, row++, 1, 1, 1.0, 0.0, new Insets(1, 3, 3, 1));
        ...
        AWTUtilities.constrain(infoPan, this.localDirectory, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST, 1, row++, 1, 1, 1.0, 0.0, new Insets(1, 3, 3, 1));
        ...
        AWTUtilities.constrain(infoPan, this.userName, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST, 1, row++, 1, 1, 1.0, 0.0, new Insets(1, 3, 3, 1));
        ...
        AWTUtilities.constrain(infoPan, this.hostName, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST, 1, row++, 1, 1, 1.0, 0.0, new Insets(1, 3, 3, 1));
        ...
        AWTUtilities.constrain(infoPan, this.connectMethod, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST, 1, row++, 1, 1, 1.0, 0.0, new Insets(1, 3, 3, 1));
        ...
        this.descPan.setBorder(new CompoundBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED), descTitle), new EmptyBorder(10, 15, 15, 15)));

        AWTUtilities.constrain(infoPan, this.descPan, GridBagConstraints.BOTH, GridBagConstraints.SOUTH, 0, row++, 2, 1, 1.0, 1.0, new Insets(10, 5, 5, 5));
