...
class ImportPanel
    ...
    performImport() {
        ...
        CVSEntryList binEntries = new CVSEntryList();

        CVSArgumentList arguments =
                CVSArgumentList.parseArgumentString
    ...
    class MyRunner
        ...
        run() {
            ...
            if (this.binEntries.size() > 0) {
                ...
                this.request.getArguments().set(0, "-kb");
    ...
    importScan(
            ...
            boolean descend, CVSEntryList entries, CVSIgnore ignore,
            CVSEntryList binEntries, CVSIgnore binaries) {
        boolean result = true;
     ...
     * @param entries        The CVSEntryList in which to place the imported entries.
    ...
    importScanDescend(
            ...
            CVSEntryList entries, CVSIgnore ignore,
            CVSEntryList binEntries, CVSIgnore binaries) {
        boolean result = true;
