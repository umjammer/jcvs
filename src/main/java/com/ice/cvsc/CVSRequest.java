...
public class CVSRequest {
    ...
    /**
     * The 'Notification' List. If this List is not null
    ...
    private CVSArgumentList arguments;
    private CVSArgumentList globalargs;
    ...
    /**
     * Returns the request's entry list as a List.
     *
    ...
    /**
     * Returns the request's argument list as a List.
     *
    ...
    /**
     * Returns the request's global argument list as a List.
     *
     * @return The request's argument list.
     */
    ...
    static public int parseEntriesSelector(char selectCh) {
        ...
        switch (selectCh) {
        case 'N':
            result = CVSRequest.ES_NONE;
            break;
        case 'A':
            result = CVSRequest.ES_ALL;
            break;
        case 'a':
            result = CVSRequest.ES_SEL;
            break;
        case 'e':
            result = CVSRequest.ES_SELALL;
            break;
        case 'M':
            result = CVSRequest.ES_ALLMOD;
            break;
        case 'm':
            result = CVSRequest.ES_SELMOD;
            break;
        case 'L':
            result = CVSRequest.ES_ALLLOST;
            break;
        case 'l':
            result = CVSRequest.ES_SELLOST;
            break;
        case 'U':
            result = CVSRequest.ES_ALLUNC;
            break;
        case 'u':
            result = CVSRequest.ES_SELUNC;
            break;
        case 'G':
            result = CVSRequest.ES_USER;
            break;
        case 'g':
            result = CVSRequest.ES_NEW;
            break;
        case 'p':
            result = CVSRequest.ES_POPUP;
            break;
        default:
            result = CVSRequest.ES_SEL;
