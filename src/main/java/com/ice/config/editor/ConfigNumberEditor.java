...
public abstract class ConfigNumberEditor extends ConfigureEditor {
    ...
    abstract public String getTypeTitle();

    abstract public String formatNumber(UserPrefs prefs, ConfigureSpec spec);

    abstract public boolean isChanged(UserPrefs prefs, ConfigureSpec spec, String numText);
    ...
    protected JPanel createEditPanel() {
        ...
        AWTUtilities.constrain(result, this.numField, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST, col++, row, 1, 1, 1.0, 0.0);
