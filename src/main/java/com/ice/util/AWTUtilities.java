...
public class AWTUtilities {
    ...
    static public Point centerDialogInParent(Dialog dialog, Component parent) {
    ...
    static public Point computeDialogLocation(Dialog dialog, int w, int h) {
    ...
    static public Point computeDialogLocation(Dialog dialog) {
        Dimension dlgSz = dialog.getSize();
        Dimension scrnSz = dialog.getToolkit().getScreenSize();
    ...
    static public Point computeDialogLocation(Dialog dialog, Component rel) {
        Dimension dlgSz = dialog.getSize();
        Dimension scrnSz = dialog.getToolkit().getScreenSize();
    ...
    static public void constrain(Container container, Component component, int fill, int anchor, int gx, int gy, int gw, int gh, double wx, double wy) {
    ...
    static public void constrain(Container container, Component component, int fill, int anchor, int gx, int gy, int gw, int gh, double wx, double wy, Insets inset) {
        GridBagConstraints c = new GridBagConstraints();
    ...
    static public void constrain(Container container, Component component, int fill, int anchor, int gx, int gy, int gw, int gh, double wx, double wy, int ipadx, int ipady) {
        GridBagConstraints c = new GridBagConstraints();
    ...
    static public Font getFont(String fontName) {
        StringTokenizer toker = new StringTokenizer(fontName, "-", false);
        ...
        try {
            ...
            System.err.println("Bad font specification '" + fontName + "' - " + ex.getMessage());
            return null;
        }

        int style = (sStyle.equalsIgnoreCase("plain")) ? Font.PLAIN : ((sStyle.equalsIgnoreCase("bold")) ? Font.BOLD : ((sStyle.equalsIgnoreCase("italic")) ? Font.ITALIC : (Font.BOLD + Font.ITALIC)));
    ...
    public static Image getImageResource(String name) throws java.io.IOException {
        return AWTUtilities.getImageResource(AWTUtilities.class, name);
    }
